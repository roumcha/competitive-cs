public class Set<T> {
  ...
  public bool IsMultiSet { [MI(R256)] get; [MI(R256)] set; }
  [MI(R256)]
  ...
  [MI(R256)] public Set(Comparison<T> comaprison) : this(Comparer<T>.Create(comaprison)) { }
  [MI(R256)] public Set() : this(Comparer<T>.Default) { }
  /// <remarks>O(log N)</remarks>
  [MI(R256)] public bool Add(T v) => insert(ref root, v);
  /// <remarks>O(log N)</remarks>
  [MI(R256)] public bool Remove(T v) => remove(ref root, v);
  /// <remarks>O(log N)</remarks>
	public T this[int index] { [MI(R256)] get { return find(root, index); } }
  public int Count { [MI(R256)] get { return root.Count; } }
  [MI(R256)]
  ...
  class Node {
    [MI(R256)] public Node(T key) { Key = key; }
    public int Count { [MI(R256)] get; [MI(R256)] private set; }
    public sbyte Height { [MI(R256)] get; [MI(R256)] private set; }
    public T Key { [MI(R256)] get; [MI(R256)] set; }
    public Node lst, rst;
    [MI(R256)]
    public void Update() {
